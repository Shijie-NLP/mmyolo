from mmdet.datasets.transforms import LoadAnnotations, PackDetInputs, RandomFlip
...
tta_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            [dict(type=PackDetInputs, meta_keys=("img_id", "img_path", "ori_shape", "img_shape", "scale_factor", "pad_param", "flip", "flip_direction"))],
        ],
    ),
]
# fmt: on
