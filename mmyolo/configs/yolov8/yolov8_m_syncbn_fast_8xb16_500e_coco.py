...
with read_base():
    from .yolov8_s_syncbn_fast_8xb16_500e_coco import *  # noqa
...
custom_hooks = custom_hooks  # noqa: F405

img_scale = img_scale  # noqa: F405
...
custom_hooks[1].switch_pipeline = train_pipeline_stage2
